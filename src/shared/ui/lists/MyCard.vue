...
import CardMap from './subcomponents/CardMap.vue'

import type { CardInfo, ImgInfo, Img, GymInfo, PersonInfo } from '@/app/types/types'
...
const currentComponent = computed(() => componentMap[props.cardType])
</script>
